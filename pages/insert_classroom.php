...
<div class="container">
<a href="edit-classroom"><button type="button" class="btn btn-outline-warning">กลับไปหน้าห้องเรียน</button></a><br>
    <form method="post" action="pages/admin/insert_classroom_save.php" enctype="multipart/form-data">
    <br><div class="form-group">
        <label for="activity_header">ชื่อห้อง</label>
        <input type="text" class="form-control" id="activity_header" name="activity_header" placeholder="หัวข้อกิจกรรม">
    </div>
    <div class="form-group">
        <label for="activity_content">คำอธิบาย</label>
